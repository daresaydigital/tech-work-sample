...
class TestPopularMoviesView: XCTestCase {
    ...
    override func setUpWithError() throws {
        let navigation = UIStoryboard(name: "PopularMovies", bundle: nil).instantiateInitialViewController() as? UINavigationController
        view = navigation?.topViewController as? PopularMoviesView
        view.presenter = self
        view.loadView()
        view.viewDidLoad()
    }
    ...
    func testViewHasTopRatedTitle() throws {
        XCTAssert(view.navigationItem.title == "Popular")
    }
