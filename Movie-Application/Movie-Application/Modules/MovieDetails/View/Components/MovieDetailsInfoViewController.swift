...
final class MovieDetailsInfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        movieInfoStackView = setupStackView(with: [releaseStackView, userScoreStackView, reviewsStackView],
                                            spacing: 0,
                                            axis: .horizontal)
        ...
        totalStackView = setupStackView(with: [movieTitleStackView, movieInfoStackView, overViewStackView],
                                        spacing: 32,
                                        axis: .vertical)
