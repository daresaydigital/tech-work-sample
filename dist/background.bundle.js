...
var store = shared.store || (shared.store = new (__webpack_require__(267))());
...
$export($export.S + $export.F * !__webpack_require__(8), 'Object', { defineProperties: __webpack_require__(246) });
...
var $export = __webpack_require__(0);
var toInteger = __webpack_require__(30);
var aNumberValue = __webpack_require__(253);
var repeat = __webpack_require__(102);
...
var $export = __webpack_require__(0);
var isInteger = __webpack_require__(254);
var abs = Math.abs;
...
// https://rwaldron.github.io/proposal-math-extensions/
var $export = __webpack_require__(0);
var scale = __webpack_require__(276);
    ...
    (0, _weather2.default)(options).then(function (values) {
      ...
      switch (endpoint) {
        case 'forecast':
          ...
          entries = values['data'].list.slice(1, 9).map(function (entry) {
            return {
...
module.exports = {
  ...
  Html5Entities: __webpack_require__(277),
  AllHtmlEntities: __webpack_require__(277)
};
