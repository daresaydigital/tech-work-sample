...
var Content = function (_Component) {
  ...
  function Content(props) {
    ...
    _this.toggleTooltip = function (insert) {
      /* Select our outer wrapper element */
      var anchor = document.getElementById('wwise-anchor');
      /* Select our search term wrapper element */
      var searchTerm = document.getElementById('wwise-searchTerm');
      ...
      if (insert) {
        ...
        if (sel.rangeCount) {
          ...
          _this.resetOldRange(searchTerm);
  ...
  _createClass(Content, [{
    ...
    key: 'resetOldRange',
    value: function resetOldRange(searchTerm) {
      if (this.state.range) {
        var oldRange = this.state.range;
        /* Create a text node, insert the contents of the search term
        wrapper in it and insert it */
        var textNode = document.createTextNode(searchTerm.textContent);
