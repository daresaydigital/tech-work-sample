...
class WeatherViewModel(
    ...
    private val forecastLiveData: MutableLiveData<Resource<Forecast>> = MutableLiveData()
    private val dailyForecastLiveData: MutableLiveData<Resource<DailyForecast>> = MutableLiveData()
    ...
    fun getForecastData(): LiveData<Forecast> = Transformations.map(forecastLiveData) {
        it.data
    }

    fun getDailyForecastData(): LiveData<DailyForecast> = Transformations.map(dailyForecastLiveData) {
            it.data
        }
