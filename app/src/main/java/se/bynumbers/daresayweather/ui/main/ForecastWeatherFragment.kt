...
class ForecastWeatherFragment : Fragment() {
    ...
    private lateinit var pageViewModel: PageForecastViewModel
    ...
    override fun onCreateView(
        ...
        val textView: TextView = root.findViewById(R.id.status_label)
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(sectionNumber: Int): ForecastWeatherFragment {
            return ForecastWeatherFragment().apply {
