...
class GetBookmarkMoviesTest {

    private val repository = mockk<Repository>()
    private val useCase = GetBookmarkMovies(repository)
    ...
    fun execute() {
        runBlockingTest {
            coEvery { repository.getBookmarkMovies(1) } returns flow {
            ...
            coVerify(exactly = 1) {
                repository.getBookmarkMovies(1)
            }
