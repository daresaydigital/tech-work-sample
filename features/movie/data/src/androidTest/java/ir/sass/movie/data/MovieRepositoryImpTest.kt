...
class MovieRepositoryImpTest : BaseDataTest() {
    ...
    @Test
    fun if_we_call_saveToLocal_from_repository_then_there_must_be_a_data_in_db() = testScope.runTest{
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun if_we_call_deleteFromLocal_from_repository_then_that_row_should_be_deleted_from_db() = testScope.runTest{
        val data = insertAStubIntoDb()
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun if_we_call_discoverMoviesFromLocal_from_repository_then_we_must_get_a_flow_of_DiscoverMovieModel_with_Domain_wrapper() = testScope.runTest{
        val data = insertAStubIntoDb()
