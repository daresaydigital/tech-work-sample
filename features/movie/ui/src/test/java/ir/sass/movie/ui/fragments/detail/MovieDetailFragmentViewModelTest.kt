...
class MovieDetailFragmentViewModelTest : BaseViewModelTest() {
    ...
    @Test
    fun `in online mode make sure when we call saveOrDelete the saveToLocal is called too`() = testScope.runTest{
        ...
        val viewModel = MovieDetailFragmentViewModel(saveMovieToLocalUseCase,deleteMovieFromLocalUseCase)
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `in offline mode make sure when we call saveOrDelete the deleteFromLocal is called too`() = testScope.runTest{
        val repo : MovieRepository = mock()
        val saveMovieToLocalUseCase = SaveMovieToLocalUseCase(repo)
        val deleteMovieFromLocalUseCase = DeleteMovieFromLocalUseCase(repo)
        val viewModel = MovieDetailFragmentViewModel(saveMovieToLocalUseCase,deleteMovieFromLocalUseCase)
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `in online mode make sure when we call saveOrDelete the _active param be false`() = testScope.runTest{
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `in online mode make sure when we call saveOrDelete the message is emmited with value Saved`() = testScope.runTest{
        val repo = fakeRepoSuccess()
        val saveMovieToLocalUseCase = SaveMovieToLocalUseCase(repo)
        val deleteMovieFromLocalUseCase = DeleteMovieFromLocalUseCase(repo)
        val viewModel = MovieDetailFragmentViewModel(saveMovieToLocalUseCase,deleteMovieFromLocalUseCase)
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `in offline mode make sure when we call saveOrDelete the _active param be false`() = testScope.runTest{
        val repo = fakeRepoSuccess()
        val saveMovieToLocalUseCase = SaveMovieToLocalUseCase(repo)
        val deleteMovieFromLocalUseCase = DeleteMovieFromLocalUseCase(repo)
        val viewModel = MovieDetailFragmentViewModel(saveMovieToLocalUseCase,deleteMovieFromLocalUseCase)
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `in offline mode make sure when we call saveOrDeletethe message is emitted with value Deleted`() = testScope.runTest{
        val repo = fakeRepoSuccess()
        val saveMovieToLocalUseCase = SaveMovieToLocalUseCase(repo)
        val deleteMovieFromLocalUseCase = DeleteMovieFromLocalUseCase(repo)
        val viewModel = MovieDetailFragmentViewModel(saveMovieToLocalUseCase,deleteMovieFromLocalUseCase)
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun `in offline mode make sure when we call saveOrDelete _navigateBack emit true`() = testScope.runTest{
        val repo = fakeRepoSuccess()
        val saveMovieToLocalUseCase = SaveMovieToLocalUseCase(repo)
        val deleteMovieFromLocalUseCase = DeleteMovieFromLocalUseCase(repo)
        val viewModel = MovieDetailFragmentViewModel(saveMovieToLocalUseCase,deleteMovieFromLocalUseCase)
